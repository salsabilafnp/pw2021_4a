        ...
        <div class="content-wrapper">
          <div class="row justify-content-center">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="font-weight-bold text-center my-3">Tambah Agenda</h3>
                  <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="nama_agenda">Nama Agenda</label>
                      <input type="text" class="form-control" name="nama_agenda" placeholder="Penerimaan Siswa Baru 2021 - 2022" autofocus>
                    </div>
                    <div class="form-group">
                      <label for="tanggal_awal">Tanggal Mulai</label>
                      <input type="text" class="form-control" name="tanggal_awal" placeholder="01 Jan 2021">
                    </div>
                    <div class="form-group">
                      <label for="tanggal_akhir">Tanggal Akhir</label>
                      <input type="text" class="form-control" name="tanggal_akhir" placeholder="31 Des 2021">
                    </div>
                    <div class="form-group">
                      <label for="jenis_agenda">Jenis Agenda</label>
                      <input type="text" class="form-control" name="jenis_agenda" placeholder="PSB untuk penerimaan siswa baru">
                    </div>
                    <!-- Tambah & Kembali -->
