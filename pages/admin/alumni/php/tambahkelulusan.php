...
if (isset($_POST['tambahkelulusan'])) {
  if (tambahkelulusan($_POST) > 0) {
    echo
    "<script>
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 cl-col-xl-8 mb-3 mb-xl-0">
                  <h3 class="font-weight-bold mt-3">Tambah Data Kelulusan</h3>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body">
                  <form class="forms" action="" method="post">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="nilai_ijazah" name="nilai_ijazah">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="nilai_skhun" class="col-sm-2 col-form-label">Nilai Skhun</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" id="nilai_skhun" name="nilai_skhun">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="tambahkelulusan">Simpan</button>
