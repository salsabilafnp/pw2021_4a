            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 cl-col-xl-8 mb-3 mb-xl-0">
                  <h3 class="font-weight-bold mt-3">Tambah Data Alumni</h3>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body ml-2">
                  <form class="forms" action="" method="post">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-3">
                        <select class="form-control" id="jenis_kelamin" name="kelamin" required>
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="tambahalumni">Simpan</button>
