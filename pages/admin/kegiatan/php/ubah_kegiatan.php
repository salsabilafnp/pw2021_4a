        ...
        <div class="content-wrapper">
          <div class="row justify-content-center">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="font-weight-bold text-center my-3">Ubah Kegiatan</h3>
                  <form action="" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?= $kegiatan['id']; ?>">
                    <div class="form-group">
                      <label for="nama_kegiatan">Nama Kegiatan</label>
                      <input type="text" class="form-control" name="nama_kegiatan" placeholder="MPLS 2021 - 2022" autofocus value="<?= $kegiatan['nama_kegiatan']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="tanggal_pelaksanaan">Tanggal Kegiatan</label>
                      <input type="text" class="form-control" name="tanggal_pelaksanaan" placeholder="15 Juni 2021" value="<?= $kegiatan['tanggal_pelaksanaan']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="jenis_kegiatan">Jenis Kegiatan</label>
                      <select class="form-control" name="jenis_kegiatan" value="<?= $kegiatan['jenis_kegiatan']; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="penyelenggara" placeholder="OSIS SMA ABCD Bandung" value="<?= $kegiatan['penyelenggara']; ?>">
                    </div>
                    <!-- Ubah & Kembali -->
