...
<head>
  ...
  <title>Tambah Anggota Ekskul</title>
  <!-- plugins:css -->
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin mb-3">
              <h3 class="font-weight-bold mt-3 text-center">Tambah Data Anggota</h3>
            </div>
          </div>
          <div class="row">
                ...
                <div class="card-body">
                  <form class="forms" action="" method="post">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-3">
                        <select class="form-control" name="ekskul" placeholder="Kode Ekskul" required>
                          ...
                          <option value="4">Paskibra</option>
                          <option value="5">Rohis</option>
                          <option value="6">Kesenian</option>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="jabatan" placeholder="Jabatan Kepengurusan" required>
                      </div>
                    </div>
