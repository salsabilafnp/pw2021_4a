            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 cl-col-xl-8 mb-3 mb-xl-0">
                  <h3 class="font-weight-bold mt-3">Tambah Data Siswa</h3>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                <div class="card-body">
                  <form class="forms" action="" method="post" enctype="multipart/form-data">
                    ...
                    <hr>
                    <p class="card-title pb-3">Alamat Lengkap</p>
                    <div class="form-group">
                      <div class="row">
                        <label for="alamat_jalan" class="col-sm-2 col-form-label">Jalan</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" id="alamat_jalan" name="alamat_jalan" placeholder="Jalan. Kenangan No.00" required>
                        </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="form-control" name="alamat_kecamatan" id="alamat_kecamatan" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" name="kode_pos" id="kode_pos" placeholder="00000" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="tanggal_masuk" id="tanggal_masuk" required placeholder="yyyy/mm/dd">
                      </div>
                    </div>
                    <hr>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_ayah" id="nama_ayah" placeholder="nama lengkap" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="status_ayah" class="col-sm-2 col-form-label">Status</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="status_ayah" id="status_ayah" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="tanggal_lahir_ayah" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="tanggal_lahir_ayah" id="tanggal_lahir_ayah" placeholder="yyyy/mm/dd" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="alamat_ayah" class="col-sm-2 col-form-label">Alamat</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="alamat_ayah" id="alamat_ayah" placeholder="alamat lengkap" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <p class="card-description pt-3" style="font-size: 15px;">Data Ibu</p>
                    <div class="form-group row">
                      <label for="nama_ibu" class="col-sm-2 col-form-label">Nama</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_ibu" id="nama_ibu" placeholder="nama lengkap" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="status_ibu" class="col-sm-2 col-form-label">Status</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="status_ibu" id="status_ibu" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="tanggal_lahir_ibu" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="tanggal_lahir_ibu" id="tanggal_lahir_ibu" placeholder="yyyy/mm/dd" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="alamat_ibu" class="col-sm-2 col-form-label">Alamat</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="alamat_ibu" id="alamat_ibu" placeholder="alamat lengkap" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <button type="submit" class="btn btn-primary mr-2" name="tambahsiswa">Simpan</button>
