                          ...
                          <tbody>
                            <?php foreach ($guru_mapel as $guru) : ?>
                              <tr>
                                ...
                                <td><?= $guru_mapel['NIP']; ?></td>
                                <td><?= $guru_mapel['nama_lengkap']; ?></td>
                                <td>
                                  <a href="../../../pages/admin/kelas/detail-guru.php?NIP=<?= $guru_mapel['NIP']; ?>"><button class="btn btn-sm btn-info">Lihat Guru</button></a>
                                </td>
                              </tr>
                            <?php endforeach; ?>
                          </tbody>
