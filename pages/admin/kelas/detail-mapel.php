        ...
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 my-3 mb-xl-0">
                  <h3 class="font-weight-bold">Sejarah Kelas 10</h3>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-md-5 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      <p class="mb-4">Guru Mata Pelajaran</p>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Pembahasan Materi</p>
                  <div class="row mt-3">
                    <div class="col-12">
                      <div class="table-responsive">
                        <table class="display expandable-table" style="width:100%">
                          ...
                          <tbody>
                            <tr>
                              <td>Pengertian Sejarah</td>
                              <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt error similique cum molestias commodi inventore suscipit eveniet, accusantium esse iure? Exercitationem nulla maxime blanditiis illum.</td>
                            </tr>
                            <tr>
                              <td>Pengertian Sejarah</td>
                              <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt error similique cum molestias commodi inventore suscipit eveniet, accusantium esse iure? Exercitationem nulla maxime blanditiis illum.</td>
