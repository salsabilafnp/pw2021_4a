        ...
        <div class="content-wrapper">
          <div class="row justify-content-center">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="font-weight-bold text-center my-3">Tambah Jadwal Pelajaran</h3>
                  <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="mapel">Mata Pelajaran</label>
                      <input type="text" class="form-control" name="mapel" placeholder="Bahasa Indonesia" autofocus required>
                    </div>
                    <div class="form-group">
                      <label for="kelas">Kelas</label>
                      <input type="text" class="form-control" name="kelas" placeholder="10-MIA-1" autofocus required>
                    </div>
                    <div class="form-group">
                      <label for="hari">Hari</label>
                      <input type="text" class="form-control" name="hari" placeholder="Senin" autofocus required>
                    </div>
                    <div class="form-group">
                      <label for="waktu_awal">Waktu Mulai</label>
                      <input type="text" class="form-control" name="waktu_awal" placeholder="07:00" autofocus required>
                    </div>
                    <div class="form-group">
                      <label for="waktu_akhir">Waktu Akhir</label>
                      <input type="text" class="form-control" name="waktu_akhir" placeholder="09:00" autofocus required>
                    </div>
                    <!-- Tambah & Kembali -->
