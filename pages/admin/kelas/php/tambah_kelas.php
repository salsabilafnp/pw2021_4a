        ...
        <div class="content-wrapper">
          <div class="row justify-content-center">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="font-weight-bold text-center my-3">Tambah Kelas</h3>
                  <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="rombel" placeholder="1">
                    </div>
                    <div class="form-group">
                      <label for="kode_kelas">Kode Kelas</label>
                      <input type="text" class="form-control" name="kode_kelas" placeholder="10-MIA-1">
                    </div>
                    <div class="form-group">
                      <label for="walikelas">NIP Wali Kelas</label>
                      <input type="text" class="form-control" name="walikelas" placeholder="NIP Wali Kelas">
                    </div>
                    <!-- Tambah & Kembali -->
