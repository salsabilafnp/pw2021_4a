...
$kelas = query("SELECT * FROM kelas WHERE kode_kelas = '$kode_kelas'");
        ...
        <div class="content-wrapper">
          <div class="row justify-content-center">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="font-weight-bold text-center my-3">ubah Kelas</h3>
                  <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="tingkat" value="10" checked autofocus>
                            10
                          </label>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="tingkat" value="11">
                            11
                          </label>
                        </div>
                      </div>
                      <div class="col-sm-3">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="tingkat" value="12">
                            12
                          </label>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="jurusan" value="<?= $kelas['jurusan']; ?>">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="rombel" placeholder="1" value="<?= $kelas['rombel']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="kode_kelas">Kode Kelas</label>
                      <input type="text" class="form-control" name="kode_kelas" placeholder="10-MIA-1" value="<?= $kelas['kode_kelas']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="walikelas">NIP Wali Kelas</label>
                      <input type="text" class="form-control" name="walikelas" placeholder="NIP Guru" value="<?= $kelas['walikelas']; ?>">
                    </div>
                    <!-- ubah & Kembali -->
